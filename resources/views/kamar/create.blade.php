                    ...
                    <form method="POST" action="{{ route('kamar.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="harga" name="harga" type="number" class="mt-1 block w-full" :value="old('harga', 0)" required min="0" />
                                <x-input-error :messages="$errors->get('harga')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="jumlah_unit" :value="__('Jumlah Unit')" />
                                <x-text-input id="jumlah_unit" name="jumlah_unit" type="number" class="mt-1 block w-full" :value="old('jumlah_unit', 1)" required min="1" />
