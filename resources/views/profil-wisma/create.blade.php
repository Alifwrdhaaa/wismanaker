<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="font-bold text-2xl text-white tracking-wide">Buat Profil Wisma</h2>
                <p class="text-kemnaker-200 text-sm mt-0.5">Lengkapi informasi utama untuk halaman publik</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="max-w-3xl">
        <div class="admin-card rounded-xl p-8">
            <form method="POST" action="{{ route('profil-wisma.store') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea id="tentang" name="tentang" rows="4"
                        class="block w-full rounded-lg border-slate-300 focus:border-kemnaker-500 focus:ring-kemnaker-500 shadow-sm text-slate-800">{{ old('tentang') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="alamat" name="alamat" rows="3"
                        class="block w-full rounded-lg border-slate-300 focus:border-kemnaker-500 focus:ring-kemnaker-500 shadow-sm text-slate-800">{{ old('alamat') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="maps_url" name="maps_url" type="text" value="{{ old('maps_url') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input id="tiktok" name="tiktok" type="text" value="{{ old('tiktok') }}"
