                    ...
                    <form method="POST" action="{{ route('pemesanan.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="nama_pemesan" name="nama_pemesan" type="text" class="mt-1 block w-full" :value="old('nama_pemesan')" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="checkin_date" name="checkin_date" type="date" class="mt-1 block w-full" :value="old('checkin_date')" required />
                                <x-input-error :messages="$errors->get('checkin_date')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="checkout_date" :value="__('Tanggal Check-out')" />
                                <x-text-input id="checkout_date" name="checkout_date" type="date" class="mt-1 block w-full" :value="old('checkout_date')" required />
